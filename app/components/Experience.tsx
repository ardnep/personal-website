      ...
      <div className={styles.sectionWrapper}>
        <div className={styles.experienceListContainer}>
          <ExperienceList>
            ...
            >
              Working accross the stack (frontend, backend and DevOps) to write
              and maintain high quality, efficient software at a Y
              Combinator-backed startup that is building an AI Content
              Generator.
            </ExperienceItem>
            <ExperienceItem
              id={2}
            ...
            >
              Conducted tutorial sessions for SC1003: Introduction to
            ...
            <ExperienceItem
              ...
              company="Nanyang Technological University, Singapore"
            >
              Worked on a Linguistics research with the topic of Computationally
